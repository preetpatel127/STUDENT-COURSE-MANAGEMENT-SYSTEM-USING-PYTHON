...
class studentClass:
    def __init__(self, root):
        ...
        self.root.config(bg="medium sea green")
        ...
        txt_addmission = Entry(self.root, textvariable=self.var_a_date, font=(
    ...
    def delete(self):
        ...
        try:
            if self.var_roll.get() == "":
                ...
                if row == None:
                    messagebox.showerror(
                        "Error", "Please select student from the list first ", parent=self.root)
                else:
    ...
    def add(self):
        ...
        try:
            if self.var_roll.get() == "":
                ...
                if row != None:
                    messagebox.showerror(
                        "Error", "Roll Number already present", parent=self.root)
                else:
                ...
                con.commit()
                messagebox.showinfo(
                    "Error", "Student Added Successfully", parent=self.root)
                self.show()
        except Exception as ex:
            messagebox.showerror("Error", f"Error due to {str(ex)}")
    ...
    def update(self):
        ...
        try:
            if self.var_roll.get() == "":
                ...
                con.commit()
                messagebox.showinfo(
                    "Error", "Student Update Successfully", parent=self.root)
                self.show()
        except Exception as ex:
            messagebox.showerror("Error", f"Error due to {str(ex)}")
