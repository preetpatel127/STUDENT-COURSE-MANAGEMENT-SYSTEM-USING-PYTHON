...
class reportClass:
    def __init__(self, root):
        ...
        # title
        title = Label(self.root, text="View Student Results", font=(
        ...
        btn_search = Button(self.root, text='Search', font=(
            "Goudy old style", 15, "bold"), bg="#03a9f4", fg="white", cursor="hand2", command=self.search).place(x=680, y=102, width=100, height=32)
        btn_clear = Button(self.root, text='Clear', font=(
            "Goudy old style", 15, "bold"), bg="#03a9f4", fg="white", cursor="hand2", command=self.clear).place(x=800, y=102, width=100, height=32)
        ...
        lbl_full = Label(self.root, text="Total Marks", font=(
        ...
        btn_delete = Button(self.root, text='Delete', font=(
            "Goudy old style", 15, "bold"), bg="red", fg="white", cursor="hand2", command=self.delete).place(x=500, y=350, width=150, height=32)
